...
@section('content')
    <div class="product-detail-page js-ga-product-data"
                                    ...
                                    <div class="list-certificate">
                                        <div class="item-certificate">
                                            ...
                                            <div class="tooltip-certificate">
                                                ...
                                                đến sức khỏe người dùng như formaldehyde, thuốc trừ sâu, kim loại nặng
                                                chiết xuất được, các chất dẫn gốc chlor hữu cơ và các chất bảo quản như
                                                tetra – và pentachlorophenol…
                                            </div>
                                        </div>
                                        <div class="item-certificate">
                                            <div class="image-certificate">
                                            ...
                                            <div class="tooltip-certificate">
                                                ISO 45001 là một hệ thống quản lý an toàn và sức khỏe nghề nghiệp, cung
                                                cấp các tiêu chí và khuôn khổ để cải thiện an toàn lao động, giảm thiểu
                                                rủi ro tại nơi làm việc và tạo điều kiện làm việc an toàn hơn
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="line-bottom">
            ...
            <div class="body-block">
                <div class="section-image">
                    <img class="lazyload" data-src="{{url("mobile/image/detail/massage/g9-banner.png")}}">
                </div>
                <div class="section-background-image">
                    <div class="content-wapper">
                        <h4 class="text-center">3 điểm khiến đệm Massage <br> Goodnight Rẻ Bất Ngờ</h4>
                        <ul>
                            <li>Đệm được sản xuất bởi tập đoàn Inoac Nhật Bản với công nghệ hiện đại hàng đầu thế giới
                            </li>
        ...
        <div class="section-feature line-bottom">
            ...
            <div class="body-block">
                <h3 class="text-center">Yên tâm trải nghiệm giấc ngủ cùng đệm Massage</h3>
                <div class="feature-items">
                    <img class="lazyload" data-src="{{url("mobile/image/detail/massage/g9-4block1.png")}}">
                    <div class="content-items">
                        <h4>Điều hoà thân nhiệt</h4>
                        <p>Bề mặt profile cutting tạo nên những khoảng trống giữa cơ thể người sử dụng và tấm nệm giúp
                            không khí và nhiệt độ dễ dàng lưu thông, khuếch tán mồ hôi và độ ẩm. </p>
                    </div>
                </div>

                <div class="feature-items">
                    <img class="lazyload" data-src="{{url("mobile/image/detail/massage/g9-4block2.png")}}">
                    <div class="content-items">
                        <h4>Cấu trúc lượn sóng</h4>
                        <p>Lớp lõi PU Foam của đệm có độ đàn hồi và độ êm ái cao, giúp duy trì tư thế tự nhiên của cột
                            sống. Sản phẩm sở hữu độ dày 9cm – độ dày lý tưởng để hỗ trợ cơ thể ổn định</p>
                    </div>
                </div>

                <div class="feature-items">
                    <img class="lazyload" data-src="{{url("mobile/image/detail/massage/g9-4block3.png")}}">
                    <div class="content-items">
                ...
                <div class="feature-items">
                    <img class="lazyload" data-src="{{url("mobile/image/detail/massage/g9-4block4.png")}}">
                    <div class="content-items">
                        <h4>Chất Lượng Nhật Bản</h4>
                        <p>Sử dụng nguồn nguyên liệu foam cao cấp, được sản xuất dưới dây chuyền công nghệ hiện đại hàng
                            đầu thế giới theo tiêu chuẩn chất lượng khắt khe của Nhật Bản .</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="image"><img class="lazyload"
                                                        data-src="{{url("web/image/certificate5.png")}}"></div>
                                <div class="content">
                                    <h5>Chứng chỉ ISO 45001</h5>
                                    <p>ISO 45001 là một hệ thống quản lý an toàn và sức khỏe nghề nghiệp, cung cấp các
                                        tiêu chí và khuôn khổ để cải thiện an toàn lao động, giảm thiểu rủi ro tại nơi
                                        làm việc và tạo điều kiện làm việc an toàn hơn</p>
                                </div>
                            </li>
                        </ul>
                    </div>
