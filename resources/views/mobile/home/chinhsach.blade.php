...
<style type="text/css">
	...
	.active.page-items{display: block;padding-bottom: 30px;}
	.page-items{display: none;}
	.collapse {padding: 0px 0 5px;}
	.collapse-items{font-size: 15px;color: #2F2F2F}
	.text-center{text-align: center;}
	.tabs-items{ padding:0px;    margin-bottom: 10px;}
	.w3-button.active{background: linear-gradient(90deg, #6C3DCE 0%, #BA87FC 100%);
		box-shadow: 0px 0px 11px 4px rgba(0, 0, 0, 0.05);color: #fff;
	}
	.w3-button br{display: none;}
	.w3-button{
		font-size: 16px;
		background: #FFFFFF; outline: none!important;    width: 100%;
		box-shadow: 0px 0px  5px 2px rgba(0, 0, 0, 0.05);    padding: 7px 15px;
		border-radius: 6px;    border: none;
	}
	.title-pages{font-size: 22px;color: #410077;padding-top: 30px;margin-bottom: 15px;}
	.collapse-items{padding: 0px 0;border-top:1px solid #eaeaea;}
	.collapse-items button.btn{border:none;background: none;color: #410077;  padding-top: 13px;padding-bottom: 13px;   padding-right: 35px;position: relative;   text-align: left;    width: 100%;font-size: 16px;padding-left: 0;outline: none!important;box-shadow: none!important}
	.collapse-items button.btn.collapsed:before{content: "+";float: right;    font-weight: 600;font-size: 23px;line-height: normal;}
	.collapse-items button.btn:before{content: "-";float: right; top:8px; position: absolute;right: 6px;  font-weight: 600;font-size: 23px;line-height: normal; }
