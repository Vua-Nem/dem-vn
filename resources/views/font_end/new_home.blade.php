...
@push('css')
<link rel="stylesheet" href="{{url("web/css/homepage1.css")}}">
...
<div class="section-banner">
  <div class="content-section">
    ...
    <a href="#" class="button-action">Xem thêm</a>
  </div>
</div>
<!-- End About us -->
<!-- Block product -->
...
<div class="section-certificate">
  ...
  <div class="items-section">
    <div class="item-certificate">
      <div class="icon">
        <img class="lazyload" data-src="{{url("web/newImage/home/certificate1.png")}}" alt="">
      </div>
    ...
    <div class="item-certificate">
      <div class="icon">
        <img class="lazyload" data-src="{{url("web/newImage/home/certificate2.png")}}" alt="">
      </div>
    ...
    <div class="item-certificate">
      <div class="icon">
        <img class="lazyload" data-src="{{url("web/newImage/home/certificate3.png")}}" alt="">
      </div>
    ...
    <div class="item-certificate">
      <div class="icon">
        <img class="lazyload" data-src="{{url("web/newImage/home/certificate4.png")}}" alt="">
      </div>
