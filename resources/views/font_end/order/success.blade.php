...
<div class="checkout-main page-success">
    <div class="page-top">
        <div class="content-sc-top" style="    border: none;">
            ...
            <div class="col-sm-6">
                <div class=" checkout-right">
                                ...
                                <div class="info-product">
                                    ...
                                    <div class="content-pr">
                                        <div class="header-block">
                                            <h3 class=name-product>{{$item->productVariant->name}}</h3>
                                        </div>
                                        <p class="option-product"><label class="label">Kích thước:</label> {{$item->productVariant->width}} x {{$item->productVariant->length}}cm</p>
                                        <p class="option-product"><label class="label">Độ dày: </label> {{$item->productVariant->thickness}}cm</p>
                                        <p class="price-pr desktop"><label class="label">Giá: </label> <span class="price">{{price($amount)}}đ</span></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="image-bottom">
                        <img src="{{url("web/image/barcode.png")}}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<style type="text/css">
    .back-home{text-align: center;padding-top: 15px;margin-bottom: 50px;}
     .button-left svg{
        fill: #6800BE;
    }
    .button-left {
