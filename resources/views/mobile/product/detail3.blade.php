...
@section('content')
    <div class="product-detail-page js-ga-product-data"
                ...
                <div class="section-background-image">
                    <div class="text-center">
                        <div class="content-wapper">
                            <h4 class="text-center">Vì sao đệm Goodnight Galaxy - Green Tea <br>có mức giá hấp dẫn đến
                                vậy?</h4>
                            <ul>
        ...
        <div class="section-feature line-bottom">
            ...
            <div class="body-block">
                <h3 class="text-center">Yên tâm trải nghiệm giấc ngủ chất lượng <br>cùng Goodnight Galaxy - Green Tea
                </h3>
                <div class="feature-items">
                    <img class="lazyload" data-src="{{url("web/image/grid-31.jpg")}}">
                    <div class="content-items">
                        <h4>Khả năng nâng đỡ cơ thể vượt trội</h4>
                        <p>Lõi foam trà xanh có độ đàn hồi tốt, độ cứng mềm vừa phải. Khi bạn thả nhẹ cơ thể trên đệm,
                            lớp foam trà xanh hoạt tính chậm rãi ôm sát lấy từng đường cong, nhẹ nhàng nâng niu cơ thể
                            bạn. </p>
                    </div>
                </div>
                <div class="feature-items">
                ...
                <div class="feature-items">
                    ...
                    <div class="content-items">
                        ...
                        <p>Vỏ bọc được làm từ vải thun thoáng khí. Loại vải này giúp đệm duy trì hình dáng, cho cảm giác
                            mượt mà mỗi khi bạn trở mình. Bề mặt vải được thiết kế giúp lưu thông khí, thoáng mát, mềm
                            mại với cả làn da người lớn và em bé.
                        </p>
                    </div>
                </div>
                <div class="feature-items">
                    ...
                    <div class="content-items">
                        ...
                        <p>Độ dày 12cm vừa vặn với mọi chiếc giường, phù hợp với người lớn tuổi mong muốn nằm ngủ trên
                            chiếc đệm có độ cao vừa phải.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="body-block">
                ...
                <div class="section-list-right">
                    <div class="certificate">
                        <ul>
                            <li>
                                <div class="image"><img class="lazyload" data-src="{{url("web/image/list-31.png")}}">
                                </div>
                                <div class="content">
            ...
            <div class="body-block">
                <div class="section-image-text section-01">
                    ...
                    <div class="content-block">
                        ...
                        <p>Đệm foam Goodnight Galaxy Green Tea có lõi foam trà xanh lành tính, kháng ẩm, kháng khuẩn. Vỏ
                            đệm
                ...
                <div class="section-image-text  section-012 ">
                    ...
                    <div class="content-block">
                        ...
                        <p>Đệm foam Goodnight Galaxy Green Tea là đệm foam một tấm, có thể cuộn hút chân không siêu nhỏ
                            gọn.
                            Dù cầu thang hay căn phòng của bạn có kích thước ra sao, Dem.vn hoàn toàn có thể vận chuyển
                            đệm
