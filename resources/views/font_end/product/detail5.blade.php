...
@section('content')
                            ...
                            <div class="list-certificate">
                                <div class="item-certificate">
                                    ...
                                    <div class="tooltip-certificate">
                                        ...
                                        chất
                                        dẫn gốc chlor hữu cơ và các chất bảo quản như tetra – và pentachlorophenol…
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="section-background-image">
        <div class="container text-center">
            <div class="content-wapper">
                <h4 class="text-center">Vì sao nên chọn đệm Foam Zinus Charcoal Foam <br>cho giấc ngủ của bạn? </h4>
                <ul>
                    <li>Memory foam than hoạt tính mềm như mây kết hợp với bột than tự nhiên, hút ẩm mang đến một giấc
                        ngủ đêm sảng khoái."
                    </li>
                    <li>Được nhận CHỨNG NHẬN CERTIPUR-US®: Nệm mút sạch sẽ và an toàn nhất.</li>
                    <li>100% sản phẩm đệm Foam Zinus Charcoal Foam đều được cuộn và ép chân không nhỏ gọn, dễ dàng di
                        chuyển.
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            <h4></h4>
                            <p>Đệm Foam Zinus Charcoal Foam có thành phần được làm bằng than củi tự nhiên, có tính chất
                                hấp thụ độ ẩm, khử mùi để mang đến một giấc ngủ đêm sảng khoái.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            <h4></h4>
                            <p>Lớp memory foam có tỉ trọng cao hỗ trợ không khí lưu thông, giúp người sử dụng tận hưởng
                                giấc ngủ ngon suốt đêm.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            <h4></h4>
                            <p>Đạt chứng chỉ CertiPUR-US chuyên ngành mút, do Alliance for Flexible Polyurethane Foam,
                                Inc. của Mỹ tiến hành đánh giá và kiểm tra nhằm mục đích xác nhận mút thân thiện với môi
                                trường, đáp ứng các tiêu chuẩn khắt khe nhất về thành phần nguyên vật liệu, khí thải, độ
                                bền và hiệu suất.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 content-block">
                    ...
                    <p>Zinus là chiếc đệm thiên về độ mềm. Lý tưởng dành cho những người hay bị mệt mỏi, căng thẳng. Độ
                        mềm của đệm sẽ giúp cơ thể được thư giãn, tạo sự nâng đỡ mềm mại và nhẹ nhàng nhất.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 content-block">
                    ...
                    <p>ZINUS đã và đang là thương hiệu tin dùng quen thuộc trên các quốc gia từ Mỹ, Canada, Úc, UK, Nhật
                        và Hàn Quốc.</p>
                    <div class="view-button">
                        <a href="#">Ngủ ngon hơn</a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 content-block">
                    ...
                    <p>Áp dụng công nghệ tiên tiến, dây chuyền sản xuất tự động hiện đại, nguyên vật liệu xanh, sạch, từ
                        hữu cơ với giá thành hợp lý cho người tiêu dùng đạt chứng chỉ CHỨNG NHẬN CERTIPUR-US® </p>
                    <div class="view-button">
                        <a href="#">Ngủ ngon hơn</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 content-block">
                    ...
                    <p>Chiếc đệm đạt chuẩn chất lượng có thể nâng đỡ đường cong cơ thể, chống lún và giảm áp lực cho cột
                        sống. Hãy lựa chọn các sản phẩm có nguồn gốc rõ ràng để đảm bảo sức khỏe về lâu dài. </p>
                    <div class="view-button">
                        <a href="#">Ngủ ngon hơn</a>
                    </div>
                </div>
    ...
    <style type="text/css">
        body .section-background-image .content-wapper {
            max-width: 950px;
        }
    </style>
    @push('scripts')
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(".attribute-group-name li").click(function () {
                    ...
                    const variantProduct = $(".product_variant:checked").val();
