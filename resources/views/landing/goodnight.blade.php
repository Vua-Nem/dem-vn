...
<noscript>
    ...
    <div class="page-landing">
        <div class="background-landing">
            <img class="lazyload" src="{{url("/landing/banner-top.jpg")}}" alt="">
                        ...
                        <div class="col-sm-12 col-md-4 column-right">
                            <div class="custom-form">
                                ...
                                <div role="form" class="cf7" id="cf7-f361-p320-o1" lang="en-US" dir="ltr">
                                    ...
                                    <input type="hidden" name="campain" value="goodnight" id="campain">
        ...
        <div class="main-image">  <div class="container" style="text-align: center; "> <img class="lazyload" src="{{url("/landing/banner-main.png")}}" alt=""></div></div>
    ...
    <div class="section-testimonial section-homepage">
        ...
        <div class="main-images"  style="text-align: center; ">  <img class="lazyload" src="{{url("/landing/banner-icon.png")}}" alt=""></div>
        <div class="section-content product" style="padding-top: 50px; padding-bottom: 30px;">
            <div class="container">
...
.main-image{padding: 30px 0 50px;}
.review-items .image{
    max-width: 100px;
    margin-right: 15px;
    margin-bottom: 0;
