...
class OrderController extends Controller
{
    ...
    public function checkOut()
    {
        ...
        return view('mobile.cart.new_check_out')
    ...
    public function payment()
    {
        ...
        return view("mobile.order.new_payment")
            ->with("customer", $customer);
    }
...
//		}
    ...
    public function success(Request $request)
    {
        ...
        return view("mobile.order.new_success")->with("order", $order);
    }

	public function cancel(Request $request){
       echo  1;die;
		$data = $request->data;
		return view("mobile.order.cancel")->with('data',$data);
	}
     ...
     * Xử lý update đơn hàng khi VNPay gọi sang thông báo thanh toán thành công (IPN)
     */
    public function vnPayOrderUpdate(Request $request)
    {
        try {
			...
			if (!empty($order)) {
				...
				if($data['vnp_Amount'] != $order->real_amount){
