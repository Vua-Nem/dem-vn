...
@section('content')
                    ...
                    <div class="col-md-5">
                        <form id="add-to-cart" method="post" action="{{route("cart.addcart")}}">
                            ...
                            <div class="product-wapper">
                                ...
                                <div class="sale-products" style="display: none">
    ...
    <div class="section-background-image">
        <div class="container text-center">
            <div class="content-wapper">
                <h4 class="text-center">3 điểm khiến đệm Goodnight Eva <br>rẻ bất ngờ</h4>
                <ul>
    ...
    <div class="section-feature">
        <div class="container">
            <h3 class="text-center">Tận hưởng giấc ngủ trọn vẹn cùng<br> Goodnight Eva</h3>
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="section-list-right">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <img class="lazyload" data-src="{{url("web/image/grid-5.jpg")}}">
                </div>
                <div class="col-md-5">
                    <ul>
                        <li>
                            <div class="image"><img class="lazyload" data-src="{{url("web/image/list-21.png")}}"></div>
                            <div class="content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 content-block">
                    ...
                    <p>Đệm foam Goodnight Eva có độ cứng mềm vừa phải, hỗ trợ mọi tư thế nằm. Dù bạn lựa chọn tư thế ngủ
                        nào, Goodnight Eva đảm bảo giúp bạn an giấc mỗi đêm. Đi kèm với chất lượng là một mức giá siêu
                        rẻ, siêu hấp dẫn</p>
            ...
            <div class="row">
                <div class="col-md-6 content-block">
                    ...
                    <p>Đệm foam Goodnight Eva với thiết kế 3 tấm có thể gấp gọn, dễ dàng mang vác khi cần chuyển nhà
                        hoặc cất trữ làm đệm dự phòng khi người thân, bạn bè tới thăm. đệm đặc biệt phù hợp với căn hộ,
