          ...
          <div id="payment-form">
            ...
            <label class="check-box vnpay">
              ...
              <div class="d-flex gap-2">
                <img class="lazyload" data-src="{{url('web/newImage/payment/visa.svg')}}" alt="">
                <img class="lazyload" data-src="{{url('web/newImage/payment/master-card.svg')}}" alt="">
                <img class="lazyload" data-src="{{url('web/newImage/payment/jcb.svg')}}" alt="">
              </div>
            </label>
              ...
              <div class="tabs-bank">
                <div class="tabs">
                  <div class="tablinks active" onclick="openCity(event, 'vcb')">
                    <img class="lazyload" data-src="{{url('web/newImage/payment/bank-vietcombank.svg')}}" alt="">
                  </div>
                  <div class="tablinks" onclick="openCity(event, 'bvd')">
                    <img class="lazyload" data-src="{{url('web/newImage/payment/bank-bidv.svg')}}" alt="">
                  </div>
                </div>
                <div id="vcb" class="tabcontent">
                  <div class="bank-items-1">
                    ...
                    <div class="d-flex flex-column" style="gap: 12px">
                      <p>
                        <img class="lazyload" data-src="{{url('web/newImage/payment/bullet.svg')}}" alt="">
