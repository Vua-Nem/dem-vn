...
@section('content')
    <div id="compare-pages">
        ...
        <div class="container">
            <div class="head-block">
                <div class="title-block">Điều gì khiến chúng tôi được tin tưởng?</div>
                <div class="content-block">
                    <div class="certificate">
                        <div class="item-certificate">
                            <img class="lazyload" data-src="{{url("/mobile/image/compare/certipur-us.jpg")}}">
                        </div>
                        <div class="item-certificate">
                            <img class="lazyload" data-src="{{url("/mobile/image/compare/intertek.jpg")}}">
                        </div>
                        <div class="item-certificate">
                            <img class="lazyload" data-src="{{url("/mobile/image/compare/amfori-bsci.jpg")}}">
                        </div>
                        <div class="item-certificate">
                            <img class="lazyload" data-src="{{url("/mobile/image/compare/okeko-tex.jpg")}}">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="item-feature image-product">
                                <div class="content-feature">
                                    <div class="value_1">
                                        ...
                                        <?php
                                            ...
                                            if (strpos($products[$currentProductId]['name'], 'Eva') == true) {
                                                $urlImage = url("/mobile/image/compare/eva.png");
                                            } else if (strpos($products[$currentProductId]['name'], 'Galaxy') == true) {
                                                $urlImage = url("/mobile/image/compare/galaxy.png");
                                            } else if (strpos($products[$currentProductId]['name'], '4Stars') == true) {
                                                $urlImage = url("/mobile/image/compare/4stars.png");
                                            }
                                        ?>
                                    ...
                                    <div class="value_2">
                                        ...
                                        <img class="image-product" src="{{url("/mobile/image/compare/bong-ep.png")}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="content-feature">
                                    <div class="value_1">
                                        <div class="value certificate">
                                            <div class="images">
                                                <div class="item-certificate">
                                                    <img src="{{url("/mobile/image/compare/okeko-tex.jpg")}}">
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function initFeatureProducts(productname, value) {
            ...
            var urlImage = "/mobile/image/compare/";
            if (value === 1) {
