...
@section('content')
    ...
    <div class="container" style="margin-bottom: 30px;padding-top: 30px;">
        <div class="row">
...
.search-result-header:before{position: absolute;content:"";left: -20px;right: -20px;height: 7px;background: #F4F4F4;top: 0;display: block!important;}
        .search-result-header {
            padding: 30px 0;margin-top: 30px;position:   relative;
        }
