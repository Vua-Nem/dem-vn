                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input name="user_name" class="form-control" value="{{$order->user_name}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="province" name="province_id" class="form-control">
                                                ...
                                                @foreach($provinces as $province)
                                                    <option @if ($order->province_id == $province->id) selected @endif
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <textarea class="form-control" name="address"
                                                      placeholder="Địa chỉ: Số nhà - Đường - Xã - Phường - Thị trấn">{{$order->address}}</textarea>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Ghi chú:</label>
