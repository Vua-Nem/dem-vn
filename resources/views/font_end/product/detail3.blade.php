...
@section('content')
    ...
    <div class="section-background-image">
        <div class="container text-center">
            <div class="content-wapper">
                <h4 class="text-center">Vì sao đệm Goodnight Galaxy - Green Tea <br>có mức giá hấp dẫn đến vậy?</h4>
                <ul>
    ...
    <div class="section-feature">
        <div class="container">
            <h3 class="text-center">Yên tâm trải nghiệm giấc ngủ chất lượng <br>cùng Goodnight Galaxy - Green Tea</h3>
            <div class="row">
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            ...
                            <p>Lõi foam trà xanh có độ đàn hồi tốt, độ cứng mềm vừa phải. Khi bạn thả nhẹ cơ thể trên
                                đệm, lớp foam trà xanh hoạt tính chậm rãi ôm sát lấy từng đường cong, nhẹ nhàng nâng niu
                                cơ thể bạn. </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            ...
                            <p>Chất liệu foam trà xanh hoạt tính có khả năng khử độ ẩm, tránh vi khuẩn nấm mốc
                                hiệu quả, an toàn cho người lớn và trẻ em</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            ...
                            <p>Vỏ bọc được làm từ vải thun thoáng khí. Loại vải này giúp đệm duy trì hình dáng, cho cảm
                                giác mượt mà mỗi khi bạn trở mình. Bề mặt vải được thiết kế giúp lưu thông khí, thoáng
                                mát, mềm mại với cả làn da người lớn và em bé.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="feature-items">
                        ...
                        <div class="content-items">
                            ...
                            <p>Độ dày 12cm vừa vặn với mọi chiếc giường, phù hợp với người lớn tuổi mong muốn nằm ngủ
                                trên chiếc đệm có độ cao vừa phải.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 content-block">
                    <h4>An toàn ngay cả với những gia đình có trẻ nhỏ</h4>
                    <p>Đệm foam Goodnight Galaxy Green Tea có lõi foam trà xanh lành tính, kháng ẩm, kháng khuẩn. Vỏ đệm
                        sáng màu giúp xua đuổi côn trùng và dễ dàng phát hiện vết bẩn.</p>
    ...
    <div class="section-image-text  section-012 ">
        <div class="container">
            <div class="row">
                <div class="col-md-6 content-block">
                    <h4>Dễ dàng vận chuyển trong không gian hẹp</h4>
                    <p>Đệm foam Goodnight Galaxy Green Tea là đệm foam một tấm, có thể cuộn hút chân không siêu nhỏ gọn.
                        Dù cầu thang hay căn phòng của bạn có kích thước ra sao, Dem.vn hoàn toàn có thể vận chuyển đệm
                        đến tận phòng ngủ của bạn</p>
                    <div class="view-button">
                        <a href="#">Ngủ ngon hơn</a>
                    </div>
                </div>
