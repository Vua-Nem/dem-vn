...
@push('css')
<link rel="stylesheet" href="{{url("mobile/css/detail.css")}}">
...
<div class="main-page">
    ...
    <div class="section-product">
          ...
          <div class="carousel-inner">
            ...
            @foreach($product->images as $img)
              <div class="carousel-item @if($i == 1) active @endif" data-index="<?php echo $i; ?>">
                <img class="lazyload" data-src="{{route("productImageShow", ["id" => $product->id, "size" => 609, "fileName" => $img->name])}}" height="230" alt="">
              </div>
            <?php $i++; ?>
            @endforeach
          </div>
      ...
      <div class="product-wrapper">
        ...
        <div class="block-variant">
          ...
          <div class="variant {{$keyCode}}">
            ...
            <div class="position-relative">
              ...
              <img class="lazyload arrow-down" data-src="{{url('mobile/newImage/detail/arrow_down.svg')}}" alt="">
            </div>
        ...
        <button class="add-to-cart js-ga-add-to-cart" data-product-name="{{$product->name}}" data-product-id="{{$product->id}}" data-product-price="{{$product->price}}" data-product-brand="{{$product->brand->name}}" data-product-variant="" type="button">
          <img class="lazyload" data-src="{{url('mobile/newImage/detail/cart.svg')}}" alt="">
          <span>Thêm vào giỏ hàng</span>
        </button>
        <div class="list-payment-method">
          <div class="title-list">
            <img src="{{url("mobile/newImage/detail/ic-title-payment.svg")}}" alt="icon title payment">Các phương thức thanh toán được chấp
            nhận
          </div>
          <div class="items-payment">
            <img src="{{url('mobile/newImage/detail/ic-payment-all.svg')}}" alt="list payment">
          </div>
        </div>
      </div>
      <div class="policies">
        <div class="item">
          <img class="lazyload" data-src="{{url('mobile/newImage/detail/policy_1.svg')}}" alt="" />
          <p>180 ngày<br><span>ngủ thử</span></p>
        </div>
        <div class="item">
          <img class="lazyload" data-src="{{url('mobile/newImage/detail/policy_2.svg')}}" alt="" />
          <p>Vận chuyển<br><span>Miễn Phí</span></p>
        </div>
        <div class="item">
          <img class="lazyload" data-src="{{url('mobile/newImage/detail/policy_3.svg')}}" alt="" />
          <p>Bảo hành<br><span>Chính Hãng</span></p>
        </div>
      </div>
    </div>
  </form>
  <div class="section-func">
    <div class="func-item">
      <img class="lazyload" data-src="{{url('mobile/newImage/detail/func-icon-1.svg')}}" alt="">
      <span>Sleep Cooler</span>
    </div>
    <div class="func-item">
      <img class="lazyload" data-src="{{url('mobile/newImage/detail/func-icon-2.svg')}}" alt="">
      <span>Designed to Enhance Sleep</span>
    </div>
    <div class="func-item">
      <img class="lazyload" data-src="{{url('mobile/newImage/detail/func-icon-3.svg')}}" alt="">
      <span>Alleviates Pressure Points</span>
    </div>
    <div class="func-item">
      <img class="lazyload" data-src="{{url('mobile/newImage/detail/func-icon-4.svg')}}" alt="">
