...
@foreach($retailers as $retailer)
    <li class="result-item">
        ...
        <div class="details">
            ...
            <p class="button-desktop button-view" data-latitude="{{$retailer->latitude}}" data-longitude="{{$retailer->longitude}}">
            ...
            <p class="button-mobile button-view" data-latitude="{{$retailer->latitude}}" data-longitude="{{$retailer->longitude}}">
                <a href="https://www.google.com/maps/@.{{$retailer->latitude}},{{$retailer->latitude}}.,20z?hl=vi-VN" target="_blank">Tìm đường</a>
                <a class="arrow-right">
                <span>
                    <i class="fa fa-angle-right" aria-hidden="true"></i>
